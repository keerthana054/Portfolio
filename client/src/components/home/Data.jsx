...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">I'm an aspiring SDE and Engineering Undergrad hailing from vibrant Chennai. Fueled by passion, I'm on a relentless quest to craft innovative solutions and make waves in the tech world. </p>
